              ...
              <div className="pb-5 px-14 invoicePrint">
                <div>
                    ...
                    <div className="px-10">
                      <div className="flex text-[12px] items-center justify-between border-b-2 pb-1 border-[#351E98]">
                        <span className="w-[200px] ">
                          {" "}
                          <b>Supplier ID:</b> {invoicePreview.Id}
                        </span>
                        <b className="mr-[88px] uppercase">Bill Info </b>
                        <b>
                          Date:
                      ...
                      <div className="flex items-center justify-between mx-auto mt-2 ">
                        <div className="flex justify-between w-[280px] overflow-hidden ">
                          ...
                          <div className="invoiceCustomerInfo">
                            <small>: Raihan {invoicePreview.job_no}</small>
                            <small>: raihan@gmail.com {invoicePreview.company_name}</small>
                            <small>: Trust Auto Solution {invoicePreview.customer_name}</small>
                            <small>: 9876543456 {invoicePreview.customer_contact}</small>
                            <small>
                              : Dhaka, Kuril {invoicePreview.customer_address}
                            </small>
                          </div>
                        </div>
                        ...
                        <div className="flex w-[280px] justify-between overflow-hidden">
                          <div className="invoiceCustomerInfo">
                            <b> Aginst Bill No </b>
                            <b>Vendor Categories </b>
                          
                          </div>
                          <div className="invoiceCustomerInfo">
                            <small>
                              : 45678{invoicePreview.car_registration_no}
                            </small>
                            <small>: Recondition Part {invoicePreview.chassis_no}</small>
                  ...
                  <div className="flex items-center justify-end text-[12px] mt-2">
                    ...
                    <b className="ml-3 ">
                      ৳ 456789 {invoicePreview?.parts_total}
                    </b>
                  </div>
