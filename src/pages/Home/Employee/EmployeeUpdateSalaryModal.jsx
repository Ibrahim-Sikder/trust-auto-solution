...
const EmployeeUpdateSalaryModal = ({ onClose }) => {
    ...
    <div className="fixed top-0 left-0 z-50 w-screen h-screen bg-black/60 backdrop-blur-sm ">
      <div className="relative left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2  w-[470px]  lg:max-w-[984px]  h-[800px] overflow-auto ">
        <div className="bg-white shadow-md dark:bg-[#12141D] rounded-xl  overflow-hidden p-10">
          ...
          <h2 className="text-xl font-semibold text-center ">Update Salary </h2>
          <div>
            <div className="mt-4">
              <div className="flex">
            ...
            <div className="mt-4">
              <div className="flex">
                <label className="block mb-1">Month of Salary</label>
                <span className="ml-1 text-red-600">*</span>
              </div>
            ...
            <div className="mt-4">
              <div className="flex">
                <label className="block mb-1">Overtime Salary</label>
                <span className="ml-1 text-red-600">*</span>
              </div>
            ...
            <div className="mt-4">
              <div className="flex">
                <label className="block mb-1">Amount of Salary</label>
                <span className="ml-1 text-red-600">*</span>
              </div>
...
export default EmployeeUpdateSalaryModal;
